...
// We could had use the'loginImagePath' directly in 'login.module.scss' with the 'background-image'  scss attribute which is also meant for that purpose
        ...
        render={({ handleSubmit }) => (
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            {/* Decide to put a "Password Type" for the Username field (even if it's not
              a "real password") as I saw on the "login.png" that you mean hide characters with the 
              small picture at the end of the input.
              I could have download a police to keep a text input with "password characters"
